    ...
    <>
        ...
        {steps.map((step, index) => (
          ...
          >
            <Badge
              ...
              className={
                isPlaying
                  ? 'mb-4 font-semibold bg-primary text-primary-foreground hover:bg-primary/90 border-0'
                  : 'mb-4'
              }
            >
              {step.number}
      ...
      <div className="mt-8 bg-card rounded-lg p-6 shadow-sm border border-border/50">
        ...
        <div className="space-y-3 text-sm text-muted-foreground">
          <p>
            Liquidity Bootstrapping Pools use{' '}
            <strong className="text-foreground">
              Weighted Math with time-dependent weights
            </strong>
            . The pool starts with high weights for the project token (e.g.,
            80/20) and linearly shifts to low weights (e.g., 20/80) over the
            sale period.
          </p>
          ...
          <p>
            ...
            <strong className="text-foreground font-mono">
              Price = (Balance₁ × Weight₂) / (Balance₂ × Weight₁)
            </strong>
          </p>
          <p>
            As weights shift over time, the price naturally decreases, creating
            sell pressure on the project token. This mechanism allows the market
            to discover a fair price through trading activity, rather than
            setting a fixed price upfront.
          </p>
