...
export function Live() {
  ...
  return (
    <section className="w-full container mx-auto max-w-5xl px-4 md:px-6 mb-16 md:mb-20">
      <div
        ref={sectionRef}
        className="relative overflow-hidden rounded-[36px] border border-border/40 bg-card"
      >
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_25%_20%,rgba(5,214,144,0.08),transparent_45%),radial-gradient(circle_at_80%_40%,rgba(5,214,144,0.05),transparent_40%)]" />
        <div className="relative grid gap-10 px-8 py-10 md:grid-cols-[1.15fr_0.85fr] md:items-center md:px-12 md:py-14">
          ...
          <div className="relative">
            <div className="relative ml-auto h-[260px] w-full max-w-[360px] rounded-[28px] border border-border/40 bg-gradient-to-br from-card via-secondary to-muted p-6 shadow-[0_24px_60px_rgba(0,0,0,0.45)]">
              <div className="absolute inset-0 rounded-[28px] bg-[linear-gradient(120deg,rgba(5,214,144,0.1),transparent_50%)]" />
              <div className="relative flex h-full flex-col">
                <div className="flex items-center justify-between text-xs text-muted-foreground">
                  <span>LBP price curve</span>
                  <span>{progressLabel} elapsed</span>
                </div>
                <div className="mt-4 flex-1 min-h-0 rounded-2xl border border-border/40 bg-black/20 p-3">
                ...
                <div className="mt-4 flex items-center justify-between text-xs text-muted-foreground">
                  ...
                  <span className="text-foreground">$1.50 USDC</span>
                </div>
              </div>
            </div>
          </div>
